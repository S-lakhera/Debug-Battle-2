                          ...
                          <TableBody>
                            {products.map((product) => (
                              ...
                              >
                                ...
                                <TableCell className="text-zinc-200">{product.category}</TableCell>
                            ...
                            {orders.map((order) => {
                              return (
                                ...
                                >
                                  ...
                                  <TableCell className="text-zinc-400 text-xs">{new Date(order.createdAt).toLocaleDateString()}</TableCell>
                                  <TableCell className="text-white font-medium">{storeSettings.currency}{order.totalAmount.toFixed(2)}</TableCell>
                                  <TableCell>
                                    <Badge variant={
                                      order.status === 'Delivered' ? 'success' :
                          ...
                          <TableBody>
                            {inventory.map((inv) => (
                              <TableRow key={inv._id} className="border-zinc-900 hover:bg-zinc-900/40">
                                ...
                                <TableCell className="text-xs text-zinc-400">{new Date(inv.updatedAt).toLocaleString()}</TableCell>
                                <TableCell>
                                  {inv.quantity === 0 ? (
                ...
                <div className="space-y-6">
                  <Card className="bg-zinc-950 border-zinc-900">
                    <CardHeader>
                      ...
                      <CardDescription className="text-zinc-400">Configure localized settings for the administration panel.</CardDescription>
                    </CardHeader>
                    <CardContent>
                    ...
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                      ...
                      {!isEditingProfile ? (
                        ...
                        <div className="flex gap-2">
                          <Button onClick={() => setIsEditingProfile(false)} className="border-zinc-850 text-zinc-300">Cancel</Button>
                      ...
                      {isEditingProfile ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                          <div className="p-4 rounded bg-zinc-900/40 border border-zinc-800 flex items-start gap-3">
                            ...
                            <div>
                              <h3 className="text-sm font-semibold text-zinc-200">Primary Skill</h3>
                          ...
                          <div className="p-4 rounded bg-zinc-900/40 border border-zinc-800 flex items-start gap-3">
                            ...
                            <div>
                              <h3 className="text-sm font-semibold text-zinc-200">Post / Position</h3>
                          ...
                          <div className="p-4 rounded bg-zinc-900/40 border border-zinc-800 flex items-start gap-3">
                            ...
                            <div>
                              <h3 className="text-sm font-semibold text-zinc-200">Roles</h3>
                          ...
                          <div className="p-4 rounded bg-zinc-900/40 border border-zinc-800 flex items-start gap-3">
                            ...
                            <div>
                              <h3 className="text-sm font-semibold text-zinc-200">Personal Address</h3>
        ...
        <DialogContent className="sm:max-w-2xl border-zinc-900 bg-zinc-950 text-slate-100 max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleProductSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-zinc-900">
              <Button type="button" onClick={() => setShowProductModal(false)} className="border-zinc-800 text-zinc-400">Cancel</Button>
      ...
      <Dialog open={showOrderModal} onOpenChange={setShowOrderModal}>
        <DialogContent className="sm:max-w-2xl border-zinc-900 bg-zinc-950 text-slate-100 max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleOrderSubmit} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-zinc-900">
              <Button type="button"  onClick={() => setShowOrderModal(false)} className="border-zinc-800 text-zinc-355">Cancel</Button>
      ...
      <Dialog open={showInventoryModal} onOpenChange={setShowInventoryModal}>
        <DialogContent className="sm:max-w-md border-zinc-900 bg-zinc-950 text-slate-100">
          ...
          <form onSubmit={handleInventorySubmit} className="p-6 space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-4 border-t border-zinc-900">
              <Button type="button" onClick={() => setShowInventoryModal(false)} className="border-zinc-800 text-zinc-350">Cancel</Button>
            ...
            <div className="space-y-6 mt-4">
              <div className="flex gap-6 items-start">
                ...
                <div className="space-y-1.5 flex-1 min-w-0">
                  ...
                  <p className="text-xs text-zinc-400">Category: {selectedViewProduct.category}</p>
